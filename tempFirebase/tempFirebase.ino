...
void loop() {
  ...
  if (Firebase.ready() && signupOK && (millis() - sendDataPrevMillis > 15000 || sendDataPrevMillis == 0)) {
    ...
    // Soil Moisture
    if (Firebase.RTDB.setInt(&fbdo, "NPK_Sensor_1/soil-moisture", soilMoisturePercent)) {
    ...
    // Nitrogen
    if (Firebase.RTDB.setFloat(&fbdo, "NPK_Sensor_1/nitrogen", val1)) {
      Serial.println("PASSED");
      Serial.println("PATH: " + fbdo.dataPath());
      Serial.println("TYPE: " + fbdo.dataType());
    }
    ...
    // Phosphorus
    if (Firebase.RTDB.setInt(&fbdo, "NPK_Sensor_1/phosphorus", val2)) {
      Serial.println("PASSED");
      Serial.println("PATH: " + fbdo.dataPath());
      Serial.println("TYPE: " + fbdo.dataType());
    }
    ...
    // Kalium
    if (Firebase.RTDB.setInt(&fbdo, "NPK_Sensor_1/kalium", val3)) {
      Serial.println("PASSED");
      Serial.println("PATH: " + fbdo.dataPath());
      Serial.println("TYPE: " + fbdo.dataType());
    }
